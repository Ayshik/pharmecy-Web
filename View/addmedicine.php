...
<form class="box" action="../Controller/addmed.php"onsubmit="return validation()" method="post">

      <div id="error_message"></div>
      <h1>Add Medicine</h1>
     
      <input type="text"id="user" name="pname" placeholder="Medicine Name" />
      <input type="text"id="mobileNumber" name="ophone" placeholder="Power">
      <input type="text"id="nid" name="pnid" placeholder="Unit Price" />
      <input type="text"id="emails" name="oaddress" placeholder="Company Name" />
     
	
	   <input type="text" id="rono"name="roono" placeholder="Quantity" />
      <input type="submit" name="addmed" value="Add Medicine" />
    </form>
