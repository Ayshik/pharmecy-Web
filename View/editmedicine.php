...
<form class="box" action="../Controller/update.php"onsubmit="return validation()" method="post">

      <div id="error_message"></div>
      <h1>Update Medicine</h1>
     
      <input type="text"id="user" name="pname"value="<?php echo "$_GET[medname]" ?>" placeholder="Medicine Name" />
